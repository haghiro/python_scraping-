        ...
        dcc.Graph(
            ...
            figure={
                ...
                'layout': go.Layout(
                    ...
                    yaxis1 = dict(title = '受講生総数', side='left', showgrid=False,range=[3000, max(subscribers)+100]),
        ...
        dcc.Graph(
            ...
            figure={
                ...
                'layout': go.Layout(
                    title = 'レビュー総数の推移',
                    xaxis = dict(title = 'date'),
                    yaxis1 = dict(title = 'レビュー総数', side='left', showgrid=False,range=[0, max(reviews)+10]),
